    ...
    public void run() {
        ...
        while (moreDocumentsToConsume) {
            try {
                ...
                Thread.sleep(3000);            //Hint: So far you have no way of knowing when all producers are done. For this part you can use a method that
                ...
                if (doc != null) {
                    ...
                    System.out.println("TotalDivs: " + totalDivs);
                } else {
